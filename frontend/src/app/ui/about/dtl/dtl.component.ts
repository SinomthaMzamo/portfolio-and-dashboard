...
export class DtlComponent implements AfterViewInit {
  ...
  events = [
    { title: 'First Sparks',year: 'Jan 2023 - Sep 2023', text: "Began programming with C# and Python, building console apps and Windows Forms interfaces. Learned core concepts such as algorithms, data types, and control structures, and discovered that every problem has a solution" },
    { title: 'WeThinkCode_', year: 'Sep 2023 - Dec 2024', text: "At WeThinkCode_, I refined my knowledge of software fundamentals while applying Test-Driven Development and Agile methodologies. I thrived in a culture that emphasised collaboration and learning from peers. The school also fostered an environment focused on social impact and solving real-world problems. I discovered that while every problem has a solution, some solutions are better than others." },
