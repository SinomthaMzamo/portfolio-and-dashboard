    ...
    projects: Project[] = [
      {
        ...
        tags: [{tag:"python", colour:"dark"}, {tag:"MVC", colour:"green"}, {tag:"oop", colour:"mustard"}, {tag:"numpy", colour:"blue"}],
      ...
      },
      {
        ...
        tags: [{tag:"rest API", colour:"green"}, {tag:"full-stack", colour:"mustard"}, {tag:"layered", colour:"dark"}],
        imgSrc: 'bhala.jpg'
      },
      {
        ...
        tags: [{tag:"encryption", colour:"dark"}, {tag:"S3", colour:"green"}, {tag:"EC2 patching", colour:"mustard"}],
        imgSrc: 'b-a-r.jpg'
      }
    ]
